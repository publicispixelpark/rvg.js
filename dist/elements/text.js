        ...
        value: function render() {
            ...
            if (util.isArray(text)) {
                text = text.map(function (line, index) {
                    ...
                    if (backgroundColor) {
                        var _TextUtils$calculateH = TextUtils.calculateHeightWidth(line, fontFamily, fontSize, padding);

                        var _TextUtils$calculateH2 = _slicedToArray(_TextUtils$calculateH, 2);

                        height = _TextUtils$calculateH2[0];
                        width = _TextUtils$calculateH2[1];
